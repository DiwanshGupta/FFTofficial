...
const HeroBanner = () => {
  return (
    <div className="relative text-white text-[20px] w-full max-w-[1536px] conta mx-auto">
      <Carousel
        autoPlay={true}
        infiniteLoop={true}
        showThumbs={false}
      ...
      >
        <div>
          <img
            ...
            className="aspect-[16/10] md:aspect-auto object-cover h-96 md:h-[40rem] lg:h-screen rounded-sm"
          />
