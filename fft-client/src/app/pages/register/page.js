...
const Register = () => {
    ...
    const handleTeacherSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await fetch("http://localhost:5000/auth/register/teacher", {
                    method: "POST",
                    headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        <div className="max-h-screen my-48 py-8 px-8 bg-transparent shadow-2xl max-w-2xl mx-auto rounded-2xl min-h-fit hover:shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 text-2xl md:text-center text-yellow-600/80 font-bold">
                ...
                >
                    <span className={`${!registerAsTeacher && "shadow-2xl shadow-black border mx-24 px-1 rounded-md bg-white"}`}>Student</span>
                </span>
                <span 
                    className={`text-center cursor-pointer ${registerAsTeacher && " shadow-2xl shadow-black border mx-24 px-1 rounded-md bg-white"}`}
            ...
            <div className="flex items-center justify-center p-3 mx-auto flex-col md:flex-row md:items-center gap-5">
                <div className="flex-1 text-white mx-0 md:mx-32">
                        ...
                        <form className="flex flex-col gap-4" >
                            <div>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    Name
                                    <br />
                                    <input type="" placeholder="Enter name....." id="name" name="name" 
                                        value={studentFormData.name}
                                        onChange={(ev) => {setStudentFormData({...studentFormData,name:ev.target.value});}}
                                ...
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    Collage <br />
                                    <input type="" placeholder="collage...." id="collage" name="collage" 
                                        value={studentFormData.collage}
                                        onChange={(ev) => {setStudentFormData({...studentFormData,collage:ev.target.value});}}
                                        className="w-3/4 md:w-full h-10 pl-2 rounded-md bg-gradient-to-r from-yellow-100 to-yellow-500 border-2 hover:bg-gradient-radial text-black/80"
                                    />
                                </span>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    Semester
                                    <br />
                                    <input  type=""  placeholder="semester..."  id="semester"  name="semester"  
                                        value={studentFormData.semester}
                                        onChange={(ev) => setStudentFormData({...studentFormData,semester:ev.target.value})}
                                        className="w-3/4 md:w-full h-10 pl-2 rounded-md bg-gradient-to-r from-yellow-100 to-yellow-500 border-2 hover:bg-gradient-radial text-black/80"
                                    />
                                </span>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    Branch
                                    <br />
                                    <input type="" placeholder="Branch,..." id="branch" name="branch" 
                                        value={studentFormData.branch}
                                        onChange={(ev) => setStudentFormData({...studentFormData,branch:ev.target.value})}
                                        className="w-3/4 md:w-full h-10 pl-2 rounded-md bg-gradient-to-r from-yellow-100 to-yellow-500 border-2 hover:bg-gradient-radial text-black/80"
                                    />
                                </span>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    ...
                                    <input type="email" placeholder="test@email.com" id="email" name="email" 
                                        ...
                                        onChange={(ev) => setStudentFormData({...studentFormData,email:ev.target.value})}
                                    />
                                    <br />
                                </span>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    ...
                                    <input type="password" placeholder="*******" id="password" name="password"
                                        ...
                                        onChange={(ev) => setStudentFormData({...studentFormData,password:ev.target.value})}
                                    />
                                    <br />
                                </span>
                                <span
                        ...
                        <form className="flex flex-col gap-4" >
                            <div>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    username
                                    <br />
                                    <input type="" placeholder="Enter name....." id="username" name="username" 
                                        value={teacherFormData.username}
                                        onChange={(ev) => {setTeacherFormData(prevState =>({...prevState,username:ev.target.value}));}}
                                        className="w-3/4 md:w-full h-10 pl-2 rounded-md bg-gradient-to-r from-yellow-100 to-yellow-500 border-2 hover:bg-gradient-radial text-black/80"
                                    />
                                </span>
                                <span className="text-[#FEAF05] py-4 text-xl">
                                    ...
                                    <input type="email" placeholder="test@email.com" id="email" name="email" 
                                        ...
                                        onChange={(ev) => setTeacherFormData(prevState =>({...prevState,email:ev.target.value}))}
                                    />
                                    <br />
                                </span>
                                <span className="text-[rgb(254,175,5)] py-4 text-xl">
                                    ...
                                    <input type="password" placeholder="*******" id="password" name="password"
                                        ...
                                        onChange={(ev) => setTeacherFormData(prevState =>({...prevState,password:ev.target.value}))}
                                    />
                                    <br />
                                </span>                                
                    ...
                    <div className="flex flex-col md:flex-row gap-2 text-sm mt-5">
                        ...
                        <Link href="/pages/login" className="text-blue-500/80 cursor-pointer">
                        Login
                        </Link>
                    </div>
                </div>
