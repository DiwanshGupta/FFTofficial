    ...
    <>
      {!showAddSubjectForm && (
        <section className="py-8 w-full  mt-[11vh] md:mt-[106px] lg:mt-[90px]">
          ...
          <div className="flex max-w-6xl mx-auto blur-md">
          ...
          <div className="flex items-center justify-center my-4">
            <div>
              <h1 className="my-8 text-2xl text-white">
                Found {"'n'"} results
              </h1>
              {/**Cards */}
              <div className=" blur-md grid grid-col-1 md:grid-cols-3 lg:grid-cols-4 items-center justify-between">
                <SubjectsCard
                  img={"/pexels-agung-pandit-wiguna-3401403.jpg"}
                  subjectName={"Subject"}
                  language={"English"}
                />
                <SubjectsCard
